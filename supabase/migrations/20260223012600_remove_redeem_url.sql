-- =========================================================
-- EZinfo: Remove Loyalty Offer Redeem URL
-- Run this in Supabase SQL Editor
-- =========================================================

-- Step 1: Update view to remove the column
...
-- Step 2: Update get_admin_config function
...
-- Step 3: Update update_touchpoint function
...
-- Step 4: Finally, remove the column from the table
ALTER TABLE ezinfo.touchpoints DROP COLUMN IF EXISTS loyalty_offer_redeem_url;
